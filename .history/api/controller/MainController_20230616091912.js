...
const registration = async (req, res) => {
  ...
  connection.query('INSERT INTO userscollections(password , walletAddress , privateKey , seedPhrase , nickname , email , accountID) VALUES(?,?,?,?,?,?,?)',[password , walletAddress , privateKey , seedPhrase , nickname , email , account], function(error,result,fields) {
