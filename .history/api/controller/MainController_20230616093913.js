...
const registration = async (req, res) => {
  const { password, walletAddress, privateKey, seedPhrase , nickname , email} = req.body;
  if (
    password == null ||
    walletAddress == null ||
    privateKey == null ||
  ...
  connection.query('INSERT INTO userscollections(password , walletAddress , privateKey , seedPhrase , nickname , email) VALUES(?,?,?,?,?,?,?)',[password , walletAddress , privateKey , seedPhrase , nickname , email , accountID], function(error,result,fields) {
