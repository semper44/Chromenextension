...
const usersData = queryUsersAccount.userAccountInfo;
  return (
      <MainLayout className="">
        { isLoading ?"loading..." :
          (<div className='border min-h-[50px] border-orange-300 justify-between items-center w-full rounded-full my-3 flex flex-row'>     
            <div className="text-sm">{"Account Id:  "} <span className="font-semibold">{queryUsersAccount.userAccountInfo.accountId}</span></div>
            <div className="">{"Balance: "+   usersData.balance}</div>
