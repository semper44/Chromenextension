      ...
      <MainLayout className="">
        { isLoading ?"loading..." :
          ...
          <div className='border min-h-[50px] border-orange-300 justify-between items-center w-11/12 lg:w-10/12  rounded-full my-3 flex flex-row px-3'>     
            <div className="text-sm">{"Account Id:  "} <span className="font-semibold text-md">{usersData.accountId}</span></div>
            <div className="text-sm">{"Balance: "} <span className="font-semibold text-md">{usersData.balance}</span></div>
