      ...
      <MainLayout className="">
        { isLoading ?"loading..." :
          ...
          <div className='border min-h-[50px] border-orange-300 justify-center lg:justify-between items-center w-11/12 lg:w-10/12  rounded-full my-3 flex flex-col lg:flex-row px-3'>     
            <div className="text-xs w-fit">{"Account Id:  "} <span className="font-semibold text-sm w-fit">{usersData.accountId}</span></div>
            <div className="text-xs w-fit">{"Balance: "} <span className="font-semibold text-sm">{usersData.balance}</span></div>
