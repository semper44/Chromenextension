...
const usersData = queryUsersAccount?.userAccountInfo;
  return (
      <MainLayout className="">
        { isLoading ?"loading..." :
          (<div>
          <div className='border min-h-[50px] border-orange-300 justify-center space-y-3 lg:justify-between items-center w-11/12 lg:w-10/12  rounded-full my-3 flex flex-col lg:flex-row px-3'>     
          ...
          <div className='border min-h-[50px] border-orange-300 justify-between flex-col items-center w-11/12 lg:w-9/12  rounded-full my-3 flex px-3'>     
            <div className="text-sm">{"Account Id:  "} <span className="font-semib old text-lg">{}</span></div>
