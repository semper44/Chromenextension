...
const usersData = queryUsersAccount?.userAccountInfo;
  return (
      <MainLayout className="">
        { isLoading ?"loading..." :
          (<div>
          <div className='border min-h-[50px] border-orange-300 justify-center space-y-3 py-2 lg:justify-between items-center w-11/12 lg:w-11/12  rounded-full my-3 flex flex-col lg:flex-row px-3'>     
            ...
            <div className="text-xs w-fit text-center ">{"Balance: "} <span className="font-semibold text-sm w-fit">{usersData.balance}</span></div>
