  ...
  return (
      <MainLayout className="">
        { isLoading ?"loading..." :
          ...
          <div className='border min-h-[50px] border-orange-300 justify-center space-y-3 lg:justify-between space-x- items-center w-11/12   rounded-full my-3 flex flex-row '>     
