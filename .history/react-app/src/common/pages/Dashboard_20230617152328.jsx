  ...
  return (
      <MainLayout className="">
        { isLoading ?"loading..." :
          ...
          <div className='border min-h-[50px] border-orange-300 justify-center space-y-3 lg:justify-between lg:space-x-4 items-center w-11/12   rounded-full my-3 flex flex-row '>     
        ...
        <div className="w-full">
            <button type="button" className=" outline-none capitalize px-5 py-1 lg:w-3/12 my-10 rounded-full border border-orange-200">
                toggle transfer
            </button>
