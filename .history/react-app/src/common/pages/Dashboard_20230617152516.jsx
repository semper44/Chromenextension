  ...
  return (
      <MainLayout className="">
        ...
        <div className="w-full">
            <button type="button" onClick={()=>setToggleTransfer(!toggleT)} className=" outline-none capitalize px-5 py-1 lg:w-3/12 my-10 rounded-full border border-orange-200">
                toggle transfer
            </button>
