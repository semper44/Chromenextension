  ...
  return (
      <MainLayout className="">
        ...
        <div className="w-full">
            <button type="button" onClick={()=>setToggleTransfer(!toggleTransfer)} className=" outline-none capitalize px-5 py-1 lg:w-3/12 my-10 rounded-full border border-orange-200">
                toggle transfer
            </button>

        </div>
        {toggleTransfer && 
        (<div className="w-full min-h-[20px] flex flex-col justify-center">
           <input className=" outline-none border border-orange-300 w-11/12 lg:w-5/12 h-5 rounded-lg" />
