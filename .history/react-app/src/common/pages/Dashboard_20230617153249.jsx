  ...
  return (
      <MainLayout className="">
        ...
        <div className="w-full">
            <button type="button" onClick={()=>setToggleTransfer(!toggleTransfer)} className=" outline-none capitalize px-5 py-1 lg:w-3/12 my- rounded-full border border-orange-200">
                toggle transfer
            </button>
