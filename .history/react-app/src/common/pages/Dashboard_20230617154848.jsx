      ...
      <MainLayout className="">
        ...
        (<div className="w-full min-h-[20px] flex flex-col justify-center items-center">
          <div className='text-center w-full text-lg font-semibold h-8'>Transfer Token</div>
           ...
           <input onChange={(e)=>setTokenTransfer((pastInput)=>({...pastInput , amount:e.target.value}))} type="submit" className=" outline-none border border-orange-300 w-11/12 lg:w-7/12 h-8 px-3 rounded-lg my-5 capitalize cursor-pointer" value="transfer" />
