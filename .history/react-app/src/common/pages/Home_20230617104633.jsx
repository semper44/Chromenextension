...
function Home() {
  ...
  useEffect(() => {
    ...
    console.log (Object.values(saveUsersDetails).length , "here")
        if (secreteFiles !== "" && loggedIn == true && Object.values(saveUsersDetails) !== "") {
          navigate("/dashboard");
        }
      ...
      if(!loggedIn && secreteFiles == "" && Object.values(saveUsersDetails) == 0){
        navigate('/')
      }       
