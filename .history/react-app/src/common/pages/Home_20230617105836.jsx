...
function Home() {
  ...
  const [saveUsersDetails , setSavedUsersDetails] =  useLocalStorage("usersDetails",{value:{} , isLoggedin:false});
  ...
  useEffect(() => {
    ...
    `;
        ...
        if ((secreteFiles != "") && (loggedIn) && (Object.values(saveUsersDetails).length != 0)) {
          navigate("/dashboard");
        }
