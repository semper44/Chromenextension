...
function Home() {
  ...
  useEffect(() => {
    ...
    `;
        ...
        if ((secreteFiles !== "") && (saveUsersDetails.isLoggedin ==true) && (Object.keys(saveUsersDetails.valueData).length != 0)) {
          navigate("/dashboard");
        }

        if((saveUsersDetails.isLoggedin == false) && (secreteFiles != "") && (Object.keys(saveUsersDetails.valueData).length == 0)){
          navigate('/login');
        }
      if((saveUsersDetails.isLoggedin == false) && (secreteFiles == "") && (Object.values(saveUsersDetails.valueData).length == 0)){
        navigate('/')
      }       
