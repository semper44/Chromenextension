...
function BigButton({buttonLabel , buttonClick}) {
    return (
      <div className='w-full flex  justify-center items-center'> 
          ...
          <S.Button disabled={true} type='button' onClick={buttonClick} className=' w-11/12 lg:w-9/12 py-1 rounded-sm font-bold text-[10px] outline-none bg-orange-300 text-white capitalize  ' ></S.Button>
          :
