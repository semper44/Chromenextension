    ...
    <div>
        <div className='w-full h-full backdrop-blur-2xl bg-black/80 px-2 pt-3 pb-5'>     
                    <div  className='h-fit w-full flex items-center '>
                        <div onClick={()=>{setShow(false);setShowInput(false)}} className='w-8 p-2 h-8 ml-1 mr-14 flex justify-center items-center border border-slate-300/50 rounded-full '><MdClose size={20} className='text-white cursor-pointer' /></div>                    
                    </div>
